...
class BudgetService:
    ...
    def add_cost(self, cost, amount):
        ...
        """
        print(f"Luokka budget_service, Lisätään seuraavat arvot listalle {cost}, {amount}")
        self._item_cost ['item'] = cost
        self._item_cost['amount'] = amount
        self._budget.append(self._item_cost,)

    def add_income(self, income, amount):
